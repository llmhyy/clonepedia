...
public class SuperTypeSelectionDialog extends OpenTypeSelectionDialog {

	private static final int ADD_ID= IDialogConstants.CLIENT_ID + 1;

	private DetermineElementWizardPage fTypeWizardPage;
	 ...
	 *            interfaces
	 */
	public SuperTypeSelectionDialog(Shell parent, IRunnableContext context, 
			DetermineElementWizardPage page, IJavaProject p, boolean isInterface) {
		
		super(parent, true, context, createSearchScope(p), 
				(isInterface ? IJavaSearchConstants.INTERFACE : IJavaSearchConstants.TYPE));
