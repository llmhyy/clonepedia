...
@SuppressWarnings(value={"restriction","rawtypes","unchecked"})
...
//					if ((fExitPosition == null || !fExitPosition.includes(offset)) && !fModel.anyPositionContains(offset)) {
	 ...
	 *        UI should act
	 */
	public CustomLinkedModeUI(LinkedModeModel model, LinkedModeUITarget[] targets) {
	 ...
	 *        UI should act
	 */
	public CustomLinkedModeUI(LinkedModeModel model, ITextViewer[] viewers) {
	 ...
	 */
	public CustomLinkedModeUI(LinkedModeModel model, LinkedModeUITarget target) {
...
//		fAssistant.setDocumentPartitioning(IJavaPartitions.JAVA_PARTITIONING);
	 ...
	 */
	public void setPositionListener(CustomLinkedModeUIFocusListener listener) {
		Assert.isNotNull(listener);
		fPositionListener= (ILinkedModeUIFocusListener) listener;
	}
